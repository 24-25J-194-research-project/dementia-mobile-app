...
class ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _updateUserProfile() async {
    try {
      ...
      user.maritalStatus = MaritalStatus.values.firstWhere((e) => e.toString() == 'MaritalStatus.$selectedMaritalStatus');
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => EducationScreen(userId: user.uid),
                    ),
                  );
                },
              ),
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkExperienceScreen(userId: user.uid),
                    ),
                  );
                },
              ),
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => FamilyMemberScreen(userId: user.uid),
                    ),
                  );
                },
              ),
